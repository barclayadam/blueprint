...
{
    /// <summary>
    /// Extensions class that augments the base <see cref="ICache"/> interface with the <see cref="GetOrCreate{T}(Blueprint.Core.Caching.ICache,string,object,System.Func{T})"/>
