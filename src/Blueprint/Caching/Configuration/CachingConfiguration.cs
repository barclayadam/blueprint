...
namespace Blueprint.Caching.Configuration
{
    ...
    ///    <configuration>
    ///      <configSections>
    ///        <section name="caching" type="Blueprint.Caching.Configuration.CachingConfiguration, Blueprint"/>
    ///      </configSections>
    ///      <caching enabled="true" provider="Blueprint.Caching.WebCache, Blueprint">
    ///        <rules>
